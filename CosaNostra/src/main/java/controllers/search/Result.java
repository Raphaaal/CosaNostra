...
/**
 * This class is used to create search query results with basic information that match the user query.
 * Ultimately, one of these results will be chosen by the user to create a FinalResult with more informations.
 *
 */
